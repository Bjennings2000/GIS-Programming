...
class Tool(object):
    def __init__(self):
        ...
        self.description = "Determines which buildings on TAMU campus are near a targeted building"
    ...
    def execute(self, parameters, messages):
        ...
        arcpy.TableToTable_conversion(gdb_path + '\Garage_Building_Intersection.dbf', r'C:\GIS-Programming\Lab 4', 'nearbyBuildings.csv')
